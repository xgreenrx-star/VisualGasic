...
/** @type {string} */
const CACHE_VERSION = '1790088573|11120717';
/** @type {string} */
const CACHE_PREFIX = 'Climatist POC-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libvisualgasic.web.template_release.wasm32.nothreads.wasm"];
