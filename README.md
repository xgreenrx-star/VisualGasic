...
> 🚀 **v5.3.0-Beta5 — Current public beta.** This README points to the Beta5 release artifacts directly so download links stay correct even if GitHub's "Latest" flag is stale. See [release notes](RELEASE_NOTES_5.3.0-Beta5.md). [Changelog](CHANGELOG.md) · 📚 [Documentation Hub](docs/DOCS.md).
>
...
**Grab a one-shot installer for your OS — no build step, no separate Godot download.** All links below target [v5.3.0-Beta5](https://github.com/xgreenrx-star/VisualGasic/releases/tag/v5.3.0-Beta5) (latest).

| Platform | Installer | Notes |
| --- | --- | --- |
| 🐧 **Linux (x86_64)** | [VisualGasic-Installer-v5.3.0-Beta5-x86_64.AppImage](https://github.com/xgreenrx-star/VisualGasic/releases/download/v5.3.0-Beta5/VisualGasic-Installer-v5.3.0-Beta5-x86_64.AppImage) | `chmod +x` and run. Or use the [Linux bootstrap script](scripts/bootstrap_install.sh) below. |
| 🪟 **Windows (x64)** | [VisualGasic-Installer-v5.3.0-Beta5-x86_64.exe](https://github.com/xgreenrx-star/VisualGasic/releases/download/v5.3.0-Beta5/VisualGasic-Installer-v5.3.0-Beta5-x86_64.exe) | Double-click to install. Win11 SmartScreen → *More info* → *Run anyway* (unsigned). |
| 🍏 **macOS (Intel & Apple Silicon)** | *not yet available* — use the `vg` CLI for now | Cross-compiled `.dmg` planned; needs a tester. |
| 📦 **Source zip / portable** | [VisualGasic_v5.3.0-Beta5_linux_x86_64.zip](https://github.com/xgreenrx-star/VisualGasic/releases/download/v5.3.0-Beta5/VisualGasic_v5.3.0-Beta5_linux_x86_64.zip) · [windows_x86_64.zip](https://github.com/xgreenrx-star/VisualGasic/releases/download/v5.3.0-Beta5/VisualGasic_v5.3.0-Beta5_windows_x86_64.zip) | For users who prefer to unzip and run. Bring your own Godot 4.6.1+. |
| 🌐 **Offline bundle** (Godot included) | [linux-x86_64.zip](https://github.com/xgreenrx-star/VisualGasic/releases/download/v5.3.0-Beta5/VisualGasic-Installer-Offline-v5.3.0-Beta5-linux-x86_64.zip) · [windows-x86_64.zip](https://github.com/xgreenrx-star/VisualGasic/releases/download/v5.3.0-Beta5/VisualGasic-Installer-Offline-v5.3.0-Beta5-windows-x86_64.zip) | No internet needed during install — ships Godot 4.6.1 inside. |
...
> 🚧 **Installer status (v5.3.0-Beta5):** Linux AppImage and Windows `.exe` one-shot installers are shipped — see the [Download & install](#-download--install) section at the top of this README. macOS `.dmg` is still in progress; on macOS use the `vg` CLI or unzip the release for now.
...
Download the AppImage/exe installer from [v5.3.0-Beta5](https://github.com/xgreenrx-star/VisualGasic/releases/tag/v5.3.0-Beta5), or a platform zip from the same release (e.g. `VisualGasic_v5.3.0-Beta5_linux_x86_64.zip`), extract, and either point the `vg` CLI at it or copy `addons/visual_gasic/` into your project. Release notes: [v5.3.0-Beta5](RELEASE_NOTES_5.3.0-Beta5.md).
...
**Current Version**: `v5.3.0-Beta5` (Current Public Beta)

> See [CHANGELOG.md](CHANGELOG.md) and the [v5.3.0-Beta5 release notes](RELEASE_NOTES_5.3.0-Beta5.md) for the latest changes.
...
- **Stable Release (v5.2.0)** - Community testing of `v5.3.0-Beta5` ongoing
