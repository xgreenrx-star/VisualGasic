...
static var _provider_map: Dictionary = {
	...
	"deepseek": {
		...
		"description": "DeepSeek Chat API — OpenAI-compatible endpoint. Requires an API key.",
		"requires_api_key": true,
	...
	"qwen": {
		...
		"description": "Alibaba Cloud DashScope API — OpenAI-compatible endpoint. Requires an API key.",
		"requires_api_key": true,
	...
	"codeium": {
		...
		"description": "Codeium Windsurf API — OpenAI-compatible endpoint. Requires an API key.",
		"requires_api_key": true,
		"default_endpoint": "https://generativelanguage.codeium.com/v1",
		"default_model": "windsurf-claude-3.5-sonnet",
		"help_url": "https://codeium.com/profile",
	},
	"amazonq": {
		"script": "res://addons/visual_gasic/gdai_openai_provider.gd",
		"display_name": "Amazon Q Developer",
		"description": "Amazon Q Developer via Bedrock Access Gateway — OpenAI-compatible endpoint. Requires an API key.",
		"requires_api_key": true,
