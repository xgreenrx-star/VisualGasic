...
func _build_data():
	...
	vba["Constants"] = [
		...
		_m("vbQuote",  "Constant", "vbQuote As String",   "Double-quote character — Chr(34). Use instead of Chr(34) in string expressions."),
		_m("vbSpace",  "Constant", "vbSpace As String",   "Space character — Chr(32). Space(1) is equivalent."),
		_m("vbComma",  "Constant", "vbComma As String",   "Comma character — Chr(44). Useful in CSV and InStr patterns."),
		_m("vbPipe",   "Constant", "vbPipe As String",    "Pipe character — Chr(124). Useful for delimited string parsing."),
