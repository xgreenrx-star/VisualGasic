...
const BASIC_GUIDE_RESOURCE := preload("res://addons/visual_gasic/plugins/vgmusic/bosca/help/basic_guide.tres")
const ADVANCED_GUIDE_RESOURCE := preload("res://addons/visual_gasic/plugins/vgmusic/bosca/help/advanced_guide.tres")
