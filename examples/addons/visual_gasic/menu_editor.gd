...
func _move_up(): pass # TODO
func _move_down(): pass # TODO
func _indent(): 
	var sel = tree.get_selected()
	if sel and sel.get_prev():
		var new_parent = sel.get_prev()
		sel.move_after(new_parent) # Wait, move_after moves sibling.
		# Reparenting in Godot Tree is tricky, need to recreate?
		pass
