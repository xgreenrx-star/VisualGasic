...
private:
    ...
    LoadDataStatement* parse_data_from_string();
    ...
    PatternMatchStatement* parse_pattern_match();
    Pattern* parse_pattern();
    MatchCase* parse_match_case();
    AdvancedType* parse_advanced_type();
    SubDefinition* parse_generic_function();
