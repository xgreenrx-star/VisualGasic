...
const VB6_CONTROL_TYPE_MAP: Dictionary = {
	...
	# 3D node types → themselves (for 3D editor integration)
	"Node3D": "Node3D",
	"MeshInstance3D": "MeshInstance3D",
	"StaticBody3D": "StaticBody3D",
	"AnimatableBody3D": "AnimatableBody3D",
	"CSGBox3D": "CSGBox3D", "CSGSphere3D": "CSGSphere3D",
	"CSGCylinder3D": "CSGCylinder3D", "CSGMesh3D": "CSGMesh3D",
	"CSGTorus3D": "CSGTorus3D", "CSGPolygon3D": "CSGPolygon3D",
	"CSGCombiner3D": "CSGCombiner3D",
	"OmniLight3D": "OmniLight3D", "SpotLight3D": "SpotLight3D",
	"DirectionalLight3D": "DirectionalLight3D",
	"Sprite3D": "Sprite3D", "AnimatedSprite3D": "AnimatedSprite3D",
	"Label3D": "Label3D",
	"AudioStreamPlayer3D": "AudioStreamPlayer3D",
	"Path3D": "Path3D", "PathFollow3D": "PathFollow3D",
	"GPUParticles3D": "GPUParticles3D", "CPUParticles3D": "CPUParticles3D",
...
const VB6_CONTROL_EVENTS: Dictionary = {
	...
	# ── 3D Node types ──
	# Every Node3D-derived type inherits: Ready, Process, PhysicsProcess,
	# EnterTree, ExitTree, Input, UnhandledInput, VisibilityChanged, Renamed.
	# Type-specific signals are added after the common set.
	"Node3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed",
		"ChildEnteredTree", "ChildExitingTree"],
	"MeshInstance3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CSGBox3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CSGSphere3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CSGCylinder3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CSGMesh3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CSGTorus3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CSGPolygon3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CSGCombiner3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"Camera3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"OmniLight3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"SpotLight3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"DirectionalLight3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"RigidBody3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"BodyEntered", "BodyExited", "BodyShapeEntered", "BodyShapeExited",
		"SleepingStateChanged", "Input", "UnhandledInput",
		"VisibilityChanged", "Renamed"],
	"CharacterBody3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"StaticBody3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"AnimatableBody3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"Area3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"BodyEntered", "BodyExited", "BodyShapeEntered", "BodyShapeExited",
		"AreaEntered", "AreaExited", "AreaShapeEntered", "AreaShapeExited",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"Sprite3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"AnimatedSprite3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"AnimationFinished", "FrameChanged",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"Label3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"AudioStreamPlayer3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Finished", "Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"Path3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"PathFollow3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"GPUParticles3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Finished", "Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"CPUParticles3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Finished", "Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
	"WorldEnvironment": ["Ready", "EnterTree", "ExitTree", "Renamed"],
	"CollisionShape3D": ["Ready", "EnterTree", "ExitTree", "Renamed"],
	"NavigationAgent3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"NavigationFinished", "WaypointReached", "TargetReached",
		"PathChanged", "VelocityComputed", "Renamed"],
	"RayCast3D": ["Ready", "Process", "PhysicsProcess", "EnterTree", "ExitTree",
		"Input", "UnhandledInput", "VisibilityChanged", "Renamed"],
}
