...
const THEME_FONT_NORMAL := preload("res://addons/visual_gasic/plugins/vgmusic/bosca/assets/fonts/fff-aquarius-bold-condensed.normal.ttf")
const THEME_FONT_MSDF := preload("res://addons/visual_gasic/plugins/vgmusic/bosca/assets/fonts/fff-aquarius-bold-condensed.msdf.ttf")
...
func _init() -> void:
	_project_theme = load("res://addons/visual_gasic/plugins/vgmusic/bosca/gui/theme/project_theme.tres") # By magic of Godot, this is a shared reference.
