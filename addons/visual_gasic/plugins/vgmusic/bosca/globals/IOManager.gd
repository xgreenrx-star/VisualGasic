...
const IMPORT_MASTER_POPUP_SCENE := preload("res://addons/visual_gasic/plugins/vgmusic/bosca/gui/widgets/popups/ImportMasterPopup.tscn")
const EXPORT_MASTER_POPUP_SCENE := preload("res://addons/visual_gasic/plugins/vgmusic/bosca/gui/widgets/popups/ExportMasterPopup.tscn")
