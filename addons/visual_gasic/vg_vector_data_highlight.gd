...
static func overlay_colors(code_edit: CodeEdit) -> Dictionary:
	...
	if lum > 0.5:
		return {
			"block": Color(0.88, 0.84, 0.98, 0.38),
			"active": Color(0.78, 0.72, 0.98, 0.52),
		}
	return {
		"block": Color(0.42, 0.35, 0.58, 0.22),
		"active": Color(0.52, 0.42, 0.72, 0.32),
	}
...
static func native_line_colors(code_edit: CodeEdit) -> Dictionary:
	...
	if lum > 0.5:
		return {
			"block": Color(0.92, 0.88, 0.98, 0.55),
			"active": Color(0.82, 0.76, 0.98, 0.72),
		}
	return {
		"block": Color(0.32, 0.28, 0.45, 0.35),
		"active": Color(0.4, 0.34, 0.55, 0.45),
	}
