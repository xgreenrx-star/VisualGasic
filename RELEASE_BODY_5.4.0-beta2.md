...
- [Godot Programming Manual v3.0.0](https://github.com/xgreenrx-star/VisualGasic/blob/main/docs/GODOT_PROGRAMMING_MANUAL.md) — Python Bridge, Narcea, Causal Chains, Let/Lambda/Try-Catch
