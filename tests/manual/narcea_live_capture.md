...
2. Open **Vibe Code** → enable **Live debug capture (this run)** → accept consent → confirm orange banner.
...
5. **Explain screen** in Vibe Code → response references stack/UI metadata; vision models get PNG when supported.
