...
The programs are organized into ten categories, each with five programs:

| Folder | Topic | Why it matters for training |
|---|---|---|
| [01_basics](01_basics/) | Variables, types, I/O | Establishes the surface vocabulary |
...
| [06_classes](06_classes/) | Instances, inheritance, properties | Object orientation in BASIC syntax |
