...
| Platform | Package |
|---|---|
| **Linux** | `VisualGasic-Installer-v5.3.0-Beta6-x86_64.AppImage` or `VisualGasic_v5.3.0-Beta6_linux_x86_64.zip` |
| **Windows** | `VisualGasic-Installer-v5.3.0-Beta6-x86_64.exe` or `VisualGasic_v5.3.0-Beta6_windows_x86_64.zip` |
