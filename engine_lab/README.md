...
This folder contains engine benchmarks, fuzz harnesses, and internal Godot test projects for Visual Gasic.

**Location:** `engine_lab/` (repo root). Legacy symlink: `demo/` → here.
