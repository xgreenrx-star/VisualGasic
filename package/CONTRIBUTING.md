...
Check the [ROADMAP.md](ROADMAP.md) for planned features with implementation notes:

**High Priority Features**:
- Watch Window - Variable monitoring during debugging
- Snap-to-Grid - Form designer alignment tools  
- IntelliSense - Code completion for VB6 keywords
- Breakpoint Conditions - Conditional expressions
