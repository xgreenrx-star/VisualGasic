...
> 🚀 **Beta Release** — v5.0.1 Beta includes a full plugin system, AGCK game construction kit, Piskel-style sprite editor, 3D game development tools, and comprehensive IDE. [See changelog](CHANGELOG.md).
